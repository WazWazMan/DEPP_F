...
#     # opencv image load
#     I1 = cv2.imread('images/512x512/p_0.png')
#     I2 = cv2.imread('result/p_0/pr_0/m_half_0/base repaint-extra-prompt.png')
...
# def run_ssim(og_image:HFImage(),file_path:str):
#     I1 = np.array(og_image)
#     I2 = cv2.imread(file_path)
